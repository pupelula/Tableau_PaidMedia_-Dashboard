...
1. Используйте фильтры в правом верхнем углу для <ins>фильтрации показателей по периоду времени и конкретным показателям эффективности</ins>.
...
6. Анализируйте диаграмму рассеяния в разделе метрики по "Campaign ID". Вы можете увидеть линию тренда в этой метрики, необычные отклонения от нее, а так же, <ins>нажав на идентификатор компании</ins> посмотреть более детальные метрики по ней.
7. Воспользуйтесь таблицей для более глубокого анализа каждой компании, <ins>используя сортировку, нажав на заголовок таблицы</ins>.
